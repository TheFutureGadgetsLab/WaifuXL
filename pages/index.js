...
export default function Main() {
  ...
  if (typeof window !== "undefined") {
    window.addEventListener('paste', (e) => {pasteListener(e, setInputURI, setFileName, setShowSidebar, setInputModalOpen)})
    window.addEventListener('dragenter', preventDefault)
    window.addEventListener('drag', preventDefault)
    window.addEventListener('dragover', preventDefault)
    window.addEventListener('dragend', preventDefault)
    window.addEventListener('dragstart', preventDefault)
    window.addEventListener('drop', (e) => {dropListener(e, setFileName, setInputURI, setShowSidebar, setInputModalOpen)})
  }  
