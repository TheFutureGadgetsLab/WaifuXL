  ...
  return (
    <>
      ...
      >
        ...
        <main className="items-center flex-shrink justify-center lg:w-8/12 p-10 text-center">
          <img src="./chibi_pablo.png" className="md:h-96 h-64 float-left" />
          <div className="md:text-left lg:mt-20 mt-5 lg:text-6xl text-2xl">Donation Links</div>
        </main>
