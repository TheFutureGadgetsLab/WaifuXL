import { EuiFlexGroup, EuiFlexItem, EuiHeader, EuiHeaderSection, EuiHeaderSectionItem, EuiText } from '@elastic/eui';
...
export const Header: FC<HeaderProps> = () => {
  return (
    <EuiHeader css={{ backgroundColor: '#FF869C' }}>
      <EuiFlexGroup gutterSize="m" responsive={false} justifyContent="center" alignItems="center">
