...
export function ErrorSVG() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" className="stroke-red-800">
...
export function GitHubSVG({ className }) {
  return (
    <a aria-label="Github Link" href="https://github.com/TheFutureGadgetsLab/WaifuXL" target="_blank">
