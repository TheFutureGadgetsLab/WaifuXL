    ...
    <Container maxWidth="md">
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4, py: 4 }}>
        <Section title="At A Glance">
          <Typography>
            <a href="https://www.waifuxl.com">WaifuXL</a> provides state of the art upscaling directly in your browser
            at the click of a button. No need to choose a noise level, no captcha, and your images are never sent to us.
        ...
        <Section title="In Depth">
          <Typography>
            Check out the full write-up <a href="https://haydn.fgl.dev/posts/the-launch-of-waifuxl/">here!</a> We send
            you neural networks to execute directly in your browser using the{' '}
